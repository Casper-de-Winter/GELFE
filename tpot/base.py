...
class TPOTBase(BaseEstimator):
    ...
    def _combine_individual_stats(self, operator_count, cv_score, result_time, individual_stats):
        ...
        stats['internal_time_elapsed'] = result_time
        stats['time_elapsed'] = (datetime.now() - self._start_datetime).total_seconds() / 60.
        return stats
    ...
    def _evaluate_individuals(self, population, features, target, sample_weight=None, groups=None):
        ...
        try:
            ...
            if self._n_jobs == 1 and not self.use_dask:
                for sklearn_pipeline in sklearn_pipeline_list:
                    ...
                    result_time_list = self._update_val(((datetime.now() - self._start_datetime).total_seconds() / 60.), result_time_list)
            else:
            ...
            self._update_evaluated_individuals_(result_score_list,result_time_list,
        ...
        self._update_evaluated_individuals_(result_score_list, result_time_list, eval_individuals_str, operator_counts, stats_dicts)
    ...
    def _update_evaluated_individuals_(self, result_score_list, result_time_list, eval_individuals_str, operator_counts, stats_dicts):
        ...
        None
        """
        for result_score, result_time, individual_str in zip(result_score_list, result_time_list, eval_individuals_str):
